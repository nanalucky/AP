...
public class BS_Main_Health : MonoBehaviour {
	...
	public int _health;
	[Tooltip("If you want to use Critical Limb Hitboxes (for example a head hitbox), assign how much the damage will be multiplied upon a Critical Hitbox Hit. (for example x2, x3, x10)")]
